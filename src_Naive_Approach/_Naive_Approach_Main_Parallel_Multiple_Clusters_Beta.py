...
def main():
    ...
    # Going through all movie clusters for now
    for DesiredMovieClusterNumber in range(100):
    ...
    #
        ...
        MovieClustersRMSE.append(CurrentMovieClusterRMSE)
        print('RMSE for current Movie Cluster #', DesiredUserClusterNumber, 'is: ', CurrentMovieClusterRMSE)
        #
        # # 6. Make a choice about whether to accept that rating or not.
        # # return 0
        print('average RMSE for the entire cluster is ', statistics.mean(MovieClustersRMSE))
